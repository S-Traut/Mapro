 ...
 */
final class Version20210301134931 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE favori_magasin (id INT AUTO_INCREMENT NOT NULL, id_magasin INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE favori_magasin_user (favori_magasin_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_B55E42F7336E8C0D (favori_magasin_id), INDEX IDX_B55E42F7A76ED395 (user_id), PRIMARY KEY(favori_magasin_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE magasin (id INT AUTO_INCREMENT NOT NULL, type_magasin_id INT DEFAULT NULL, id_utilisateur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, siren VARCHAR(255) NOT NULL, etat TINYINT(1) NOT NULL, image VARCHAR(255) NOT NULL, longitude VARCHAR(255) NOT NULL, latitude VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, INDEX IDX_54AF5F273D0ABCC6 (type_magasin_id), INDEX IDX_54AF5F27C6EE5C49 (id_utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE favori_magasin_user ADD CONSTRAINT FK_B55E42F7336E8C0D FOREIGN KEY (favori_magasin_id) REFERENCES favori_magasin (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE favori_magasin_user ADD CONSTRAINT FK_B55E42F7A76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE favori_magasin_user DROP FOREIGN KEY FK_B55E42F7336E8C0D');
        ...
        $this->addSql('ALTER TABLE favori_magasin_user DROP FOREIGN KEY FK_B55E42F7A76ED395');
        ...
        $this->addSql('DROP TABLE favori_magasin_user');
